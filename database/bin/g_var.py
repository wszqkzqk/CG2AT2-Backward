...
if __name__ == "g_var" and 'start_dir' not in locals():
    ...
    parser.add_argument('-rna_itp', help='rna itp file (Optional)',metavar='rna.itp',type=str, nargs='*')
    ...
    parser.add_argument('-rna_ff', help='choose your rna forcefield. (Optional)',metavar='charmm36',type=str)
    ...
    if args.rna_itp:
        RNA_top = [args.loc+os.path.basename(rna_itp) for rna_itp in args.rna_itp]
    else:
        RNA_top = []
    RNA_ff = args.rna_ff
    box_vec = ''
